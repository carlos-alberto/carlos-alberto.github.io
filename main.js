...
var _user$project$FaultSelector$scrapReasons = {
	ctor: '::',
	_0: 'Process',
	_1: {
		ctor: '::',
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: 'Fanfare/Malatex Missing',
														_1: {
															ctor: '::',
															_0: 'Quality Dept Scrap',
															_1: {
																ctor: '::',
																_0: 'White Rabbit',
																_1: {
...
var _user$project$FaultSelector$makeRow = F2(
	function (msg, i) {
		return A2(
			...
			A2(
				...
				A2(
					...
					_user$project$FaultSelector$scrapReasons)));
	});
var _user$project$FaultSelector$makeHeaderRow = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Tool Number'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
...
var _user$project$FaultSelector$makeTable = function (msg) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$FaultSelector$makeHeaderRow,
					_1: {
						ctor: '::',
						_0: A2(
							...
							A2(
								_elm_lang$core$List$map,
								_user$project$FaultSelector$makeRow(msg),
...
var _user$project$FaultSelector$faultSelectorView = function (msg) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$FaultSelector$makeTable(msg),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Projects$partTable = F2(
	function (msg, project) {
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(part.id),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(part.description),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('P/N'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
		...
		var parts = _user$project$Projects$projectToParts(project);
		var body = A2(
			_elm_lang$html$Html$tbody,
			{ctor: '[]'},
			A2(_elm_lang$core$List$map, element, parts));
		return A2(
			_elm_lang$html$Html$table,
			{
				ctor: '::',
...
var _user$project$Projects$allProjects = {
	ctor: '::',
	_0: _user$project$Projects$P32S,
	_1: {
		ctor: '::',
			...
			case 'ReasonClick':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							toolAndReason: _elm_lang$core$Maybe$Just(info)
						}),
...
var _user$project$Main$partSelectorView = function (project) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: A2(_user$project$Projects$partTable, _user$project$Main$PartClick, project),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$ProjectClick = function (a) {
	return {ctor: 'ProjectClick', _0: a};
};
var _user$project$Main$projectSelectorView = function (model) {
	var class_ = function (project) {
		return _elm_lang$core$Native_Utils.eq(project, model.project) ? 'active' : '';
	};
	var makeElement = function (project) {
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$a,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$ProjectClick(project)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							_user$project$Projects$toString(project)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	};
	var elements = A2(_elm_lang$core$List$map, makeElement, _user$project$Projects$allProjects);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$partSelectorView(model.project),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$ReasonClick = F2(
	function (a, b) {
		return {ctor: 'ReasonClick', _0: a, _1: b};
	});
var _user$project$Main$view = function (model) {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$currentStateView(model),
				_1: {ctor: '[]'}
			}
		});
};
